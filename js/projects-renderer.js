    ...
    container.innerHTML = projects.map(p => `
      <article class="group rounded-xl overflow-hidden border p-4 bg-white dark:bg-[#16131D]">
        <a href="${p.contentUrl}" class="block">
          <div class="card-img-round ratio-4-3 mb-3">
            <img src="${p.thumb || 'assets/images/projects/tendawema/tendawema-thumb.png'}" alt="${p.title} thumbnail" class="w-full h-full object-cover" loading="lazy"/>
          </div>
